var app = angular.module('restaurantCms', ['ui.router', 'ngAnimate', 'ngSanitize', 'ngFileUpload', 'textAngular', 'ui.bootstrap', 'toaster']);
...
app.run(function ($rootScope, $state, userService) {
    $rootScope.$on('$stateChangeSuccess', function (event, toState, toParams, fromState, fromParams) {
        ...
        if (toState.pageName) {
            document.title = 'Restaurant CMS | ' + toState.pageName;
        }
